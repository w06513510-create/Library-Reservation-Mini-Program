  ...
  <div class="top-right-btn" :style="style">
    <el-row>
      <el-tooltip v-if="search" class="item" effect="dark" :content="showSearch ? '隐藏搜索' : '显示搜索'" placement="top">
        <el-button circle icon="Search" :aria-label="showSearch ? '隐藏搜索栏' : '显示搜索栏'" @click="toggleSearch()" />
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="刷新" placement="top">
        <el-button circle icon="Refresh" aria-label="刷新" @click="refresh()" />
      </el-tooltip>
      <el-tooltip v-if="columns" class="item" effect="dark" content="显示/隐藏列" placement="top">
        <div class="show-btn">
          <el-popover placement="bottom" trigger="click">
            ...
            ></el-tree>
            <template #reference>
              <el-button circle icon="Menu" aria-label="显示或隐藏列" />
            </template>
          </el-popover>
        </div>
      </el-tooltip>
